...
import { Eye, EyeOff, Mail, Lock, Sparkles, Users, Building, Mountain, TreePine, Waves, Compass, ArrowLeft } from 'lucide-react';
          ...
          >
            ...
            <div className="glass-premium rounded-3xl p-8 relative overflow-hidden backdrop-blur-xl">
              ...
              <div className="lg:hidden text-center mb-8 relative z-10">
                ...
                <p className="text-white/70">Continue your Jharkhand adventure</p>
              </div>

              {/* User Type Selection */}
              <div className="mb-8 relative z-10">
                <Label className="text-white/90 text-sm mb-4 block">Sign in as:</Label>
              ...
              <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                ...
                <div className="relative my-8">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-4 glass-dark text-white/70 rounded-full">Or continue with</span>
                  </div>
                </div>
