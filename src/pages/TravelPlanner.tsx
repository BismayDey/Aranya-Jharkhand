...
import { MapPin, Clock, Users, Star, Calendar, Heart, Camera, Mountain, Utensils, Wifi, Bed, Car, Shield, Phone, Globe } from 'lucide-react';

const interests = [
  { id: 'nature', label: 'Nature & Wildlife', icon: '🌿', color: 'from-green-400 to-emerald-500', description: 'Ancient forests, cascading waterfalls, rare wildlife safaris' },
  { id: 'culture', label: 'Tribal Heritage', icon: '🎭', color: 'from-purple-400 to-pink-500', description: 'Indigenous cultures, sacred traditions, authentic villages' },
  { id: 'adventure', label: 'Extreme Adventures', icon: '🏔️', color: 'from-orange-400 to-red-500', description: 'Adrenaline sports, mountain expeditions, thrill activities' },
  { id: 'spiritual', label: 'Sacred Journeys', icon: '🕉️', color: 'from-yellow-400 to-orange-500', description: 'Holy temples, meditation retreats, spiritual awakening' },
  { id: 'photography', label: 'Visual Storytelling', icon: '📸', color: 'from-blue-400 to-indigo-500', description: 'Breathtaking landscapes, wildlife photography, cultural portraits' },
  { id: 'food', label: 'Culinary Exploration', icon: '🍽️', color: 'from-pink-400 to-rose-500', description: 'Traditional tribal cuisine, cooking masterclasses, food heritage' },
  { id: 'wellness', label: 'Holistic Wellness', icon: '🧘‍♀️', color: 'from-teal-400 to-cyan-500', description: 'Ayurvedic healing, yoga retreats, natural therapies' },
  { id: 'history', label: 'Ancient Mysteries', icon: '🏛️', color: 'from-amber-400 to-yellow-500', description: 'Prehistoric rock art, archaeological wonders, historical sites' }
];

const budgetRanges = [
  { id: 'budget', label: 'Forest Explorer', range: '₹12,000 - ₹25,000', icon: '💰', features: ['Eco-lodges', 'Group adventures', 'Local transport', 'Basic amenities'] },
  { id: 'standard', label: 'Heritage Traveler', range: '₹25,000 - ₹55,000', icon: '💳', features: ['Heritage hotels', 'Private guides', 'Comfort transport', 'Premium experiences'] },
  { id: 'premium', label: 'Luxury Explorer', range: '₹55,000 - ₹95,000', icon: '💎', features: ['Luxury resorts', 'Exclusive experiences', 'Personal concierge', 'Private transport'] },
  { id: 'luxury', label: 'Elite Aaranya', range: '₹95,000+', icon: '👑', features: ['Ultra-luxury accommodations', 'Helicopter access', 'Celebrity chef', 'Bespoke experiences'] }
];

const accommodationTypes = [
  { id: 'tribal-homestay', label: 'Tribal Homestay', icon: '🏠', description: 'Live with indigenous families, authentic cultural immersion' },
  { id: 'heritage-palace', label: 'Heritage Palace', icon: '🏰', description: 'Royal accommodations with regal ambiance and modern luxury' },
  { id: 'eco-luxury-resort', label: 'Eco-Luxury Resort', icon: '🌳', description: 'Sustainable luxury amidst pristine forests' },
  { id: 'adventure-basecamp', label: 'Adventure Basecamp', icon: '⛺', description: 'High-altitude camps with stunning mountain views' },
  { id: 'forest-treehouse', label: 'Canopy Treehouse', icon: '🌲', description: 'Elevated stays in ancient tree canopies' },
  { id: 'wellness-retreat', label: 'Wellness Sanctuary', icon: '🧘', description: 'Healing centers focused on mind-body rejuvenation' }
];
...
const generateSuperDetailedItinerary = (formData: any): EnhancedTravelPlan[] => {
  const calculateDynamicPrice = (basePrice: number, groupSize: number, budget: string, duration: number, complexity: number = 1) => {
  ...
  const superPlans: EnhancedTravelPlan[] = [
    {
      ...
      destinations: [
        ...
        },
        {
          ...
          highlights: ["Authentic culture", "Traditional crafts", "Oral histories"]
        }
      ],
      detailedHighlights: [
        {
      ...
      price: `₹${calculateDynamicPrice(basePrice, formData.groupSize, formData.budget, tripDuration, 1.5).toLocaleString()}`,
      priceBreakdown: {
        accommodation: 35,
        transport: 15,
        activities: 25,
      ...
      bestFor: ["Wildlife photographers", "Adventure seekers", "Nature enthusiasts", "Cultural explorers"],
      seasonality: {
        best: ["October-March (Cool & Clear)", "November-February (Peak Wildlife)"],
      ...
      culturalImpact: "High positive impact - 70% of tour fees support local tribal communities and forest conservation initiatives",
      itinerary: [
        {
          day: 1,
          ...
          activities: [
            {
              ...
              description: "Private vehicle journey through scenic Chotanagpur plateau with expert guide providing historical context and wildlife briefing",
              difficulty: "Easy",
              cost: 0
            },
            {
              ...
              description: "Check into eco-lodge, equipment briefing, forest department permits, and orientation session with chief naturalist",
              difficulty: "Easy",
              cost: 2500
            },
            {
              ...
              description: "First game drive in open jeep through core area with chances of spotted deer, peacocks, and if lucky - big cats",
              difficulty: "Moderate",
              cost: 3500
            },
            {
              ...
              description: "Learn advanced techniques for low-light wildlife photography with professional wildlife photographer",
              difficulty: "Easy",
              cost: 1500
            }
          ],
          ...
          accommodation: {
            ...
            rating: 4.8,
            amenities: ["Solar powered", "Organic toiletries", "Private bathrooms", "Forest view deck"],
            sustainabilityFeatures: ["Rainwater harvesting", "Solar energy", "Waste composting", "Local staff employment"]
          },
          transportation: {
          ...
          activities: [
            {
              ...
              description: "Follow fresh tiger pugmarks with expert tracker, use camera traps, and experience the forest awakening with 300+ bird species",
              difficulty: "Challenging",
              cost: 4500
            },
            {
              ...
              description: "Guided walk through elephant migration paths, observe feeding signs, and learn about human-animal conflict resolution",
              difficulty: "Moderate",
              cost: 2000
            },
            {
              ...
              description: "Climb 80ft observation tower, butterfly identification workshop, and contribute to citizen science data collection",
              difficulty: "Moderate",
              cost: 2500
            },
            {
              ...
              description: "Advanced night safari using thermal cameras to spot leopards, sloth bears, and nocturnal wildlife behavior",
              difficulty: "Challenging",
              cost: 5000
            }
          ],
      ...
      testimonials: [
        {
          ...
          rating: 5,
          review: "Absolutely extraordinary! The level of detail and expertise exceeded all expectations. Captured Bengal tiger shots that are now featured in National Geographic.",
        ...
        },
        {
          ...
          rating: 5,
          review: "This wasn't just a trip, it was a life-changing experience. The cultural immersion with tribal families gave me perspectives I never imagined.",
    ...
    },
    {
      ...
      duration: `${Math.max(tripDuration, 8)} Days / ${Math.max(tripDuration, 8) - 1} Nights`,
      destinations: [
        {
          name: "Deoghar - Sacred Jyotirlinga Complex",
          type: 'primary',
          coordinates: "24.4847° N, 86.6908° E",
          highlights: ["Baidyanath Temple", "Spiritual ceremonies", "Sacred geography"]
        },
        {
          name: "Ancient Santhal Heartland - Dumka",
          type: 'primary',
          coordinates: "24.2676° N, 87.2454° E",
          highlights: ["Traditional villages", "Living heritage", "Oral traditions"]
        },
        {
          name: "Prehistoric Rock Art Galleries - Hazaribagh",
          type: 'secondary',
          coordinates: "23.9929° N, 85.3647° E",
          highlights: ["10,000-year-old paintings", "Archaeological sites", "Historical mysteries"]
        },
        {
          name: "Secret Shamanic Caves",
          type: 'hidden-gem',
          coordinates: "Protected sacred location",
          highlights: ["Healing ceremonies", "Ancient rituals", "Spiritual masters"]
        }
      ],
      detailedHighlights: [
        {
      ...
      price: `₹${calculateDynamicPrice(basePrice * 1.3, formData.groupSize, formData.budget, Math.max(tripDuration, 8), 1.8).toLocaleString()}`,
      priceBreakdown: {
        accommodation: 30,
        transport: 20,
        activities: 25,
      ...
      difficulty: "Moderate",
      bestFor: ["Spiritual seekers", "Cultural enthusiasts", "History buffs", "Art lovers", "Philosophy students"],
      seasonality: {
        best: ["October-March (Festival season)", "November-January (Perfect weather)"],
        good: ["April-June (Pre-monsoon)", "September (Post-monsoon clear skies)"],
      ...
      culturalImpact: "Maximum positive impact - direct support to traditional artisans, cultural preservation, and community development",
      itinerary: [
        {
          day: 1,
          ...
          activities: [
            {
              ...
              description: "Traditional purification rituals, Sanskrit introduction session, and scenic journey through spiritual landscapes",
              difficulty: "Easy",
              cost: 1500
            },
            {
              ...
              description: "Detailed temple architecture study, historical significance briefing, and participation in daily ceremonies",
              difficulty: "Easy",
              cost: 2000
            },
            {
              ...
              description: "Explore 12 connected temples, understand cosmic alignments, and learn about temple construction mysteries",
              difficulty: "Moderate",
              cost: 1500
            },
            {
              ...
              description: "Participate in traditional evening prayers with hundreds of devotees, followed by guided meditation session",
              difficulty: "Easy",
              cost: 500
            }
          ],
          ...
          accommodation: {
            ...
            rating: 4.6,
            amenities: ["Meditation rooms", "Prayer halls", "Spiritual library", "Ayurvedic spa"],
            sustainabilityFeatures: ["Solar heating", "Organic gardens", "Rainwater systems", "Zero plastic policy"]
          },
          transportation: {
      ...
      testimonials: [
        {
          ...
          rating: 5,
          review: "Incredible depth of knowledge from guides. The cultural immersion was authentic and respectful. Learned more in 8 days than years of academic study.",
    ...
    },
    {
      ...
      duration: `${Math.max(tripDuration, 7)} Days / ${Math.max(tripDuration, 7) - 1} Nights`,
      destinations: [
        {
        ...
        },
        {
          ...
          highlights: ["Extreme camping", "Survival training", "Elite challenges"]
        }
      ],
      detailedHighlights: [
        {
      ...
      price: `₹${calculateDynamicPrice(basePrice * 1.8, formData.groupSize, formData.budget, Math.max(tripDuration, 7), 2.2).toLocaleString()}`,
      priceBreakdown: {
        accommodation: 25,
        transport: 15,
        activities: 40,
      ...
      difficulty: "Extreme",
      bestFor: ["Adrenaline junkies", "Adventure athletes", "Survival enthusiasts", "Extreme sports professionals"],
      seasonality: {
        best: ["October-February (Perfect weather)", "March-May (Clear skies)"],
        good: ["September (Post-monsoon)", "June (Pre-monsoon activities)"],
        avoid: ["July-August (Monsoon - safety concerns)", "Peak summer for altitude activities"]
      },
      inclusions: [
      ...
      culturalImpact: "Moderate positive impact - supports local adventure tourism and employs tribal youth as guides",
      itinerary: [
        {
          day: 1,
          ...
          activities: [
            {
              ...
              description: "Scenic drive to Patratu Valley with equipment loading and safety briefing during transport",
              difficulty: "Easy",
              cost: 2000
            },
            {
              ...
              description: "Complete equipment check, safety protocol training, and basic rope techniques practice",
              difficulty: "Moderate",
              cost: 3500
            },
            {
              ...
              description: "Explore activity zones, weather briefing, and customize adventure plan based on group skills",
              difficulty: "Easy",
              cost: 1000
            },
            {
              ...
              description: "Group bonding activities, safety protocols review, and preparation for upcoming challenges",
              difficulty: "Easy",
              cost: 500
            }
          ],
          ...
          accommodation: {
            ...
            rating: 4.3,
            amenities: ["Weather-resistant tents", "Shared facilities", "Equipment storage", "Emergency communication"],
            sustainabilityFeatures: ["Solar power", "Waste management", "Local sourcing", "Environmental impact minimization"]
          },
          transportation: {
      ...
      testimonials: [
        {
          ...
          rating: 5,
          review: "Incredible adrenaline rush! The safety standards were top-notch and the challenges pushed my limits. Best adventure experience in Asia.",
  ...
  const filteredPlans = superPlans.filter(plan => {
    ...
    const interestScore = formData.selectedInterests.reduce((score: number, interest: string) => {
      switch(interest) {
        case 'nature': return score + (plan.id.includes('nature') ? 10 : 0) + (plan.id.includes('ultimate') ? 5 : 0);
        case 'culture': return score + (plan.id.includes('heritage') || plan.id.includes('cultural') ? 10 : 0);
        case 'adventure': return score + (plan.id.includes('adventure') || plan.id.includes('extreme') ? 10 : 0);
        case 'spiritual': return score + (plan.id.includes('heritage') || plan.id.includes('cultural') ? 8 : 0);
        case 'photography': return score + (plan.id.includes('nature') || plan.id.includes('ultimate') ? 7 : 0);
    ...
    const budgetScore = (() => {
      switch(formData.budget) {
        case 'budget': return plan.difficulty === 'Extreme' ? 3 : 10;
        case 'standard': return plan.difficulty === 'Extreme' ? 7 : 10;
        case 'premium': return 10;
        case 'luxury': return plan.difficulty === 'Extreme' || plan.difficulty === 'Challenging' ? 10 : 8;
        default: return 5;
      }
    })();
    ...
    const groupScore = (() => {
      if (formData.groupSize <= 2) return plan.difficulty === 'Extreme' ? 6 : 10;
  ...
  return filteredPlans.length >= 2 ? filteredPlans.slice(0, 3) : superPlans.slice(0, 3);
};
...
export function TravelPlanner() {
  ...
  const [selectedPlan, setSelectedPlan] = useState<EnhancedTravelPlan | null>(null);
  ...
  const steps = [
    { number: 1, title: "Travel Details", icon: "📅", description: "When & Who" },
    { number: 2, title: "Preferences", icon: "🎯", description: "What & How" },
    { number: 3, title: "Your Aaranya Plans", icon: "🗺️", description: "Customized Adventures" }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          ...
          >
            ...
            <p className="text-lg text-gray-400 max-w-3xl mx-auto">
              Advanced algorithms analyze 500+ variables to craft your perfect Jharkhand wilderness experience
            </p>
          </motion.div>
          ...
          >
            <motion.button
              whileHover={{ scale: 1.05, boxShadow: "0 20px 40px rgba(24, 182, 104, 0.3)" }}
              whileTap={{ scale: 0.95 }}
          ...
          >
            {[
              ...
              { icon: "🌿", title: "Eco-Conscious", desc: "Sustainable tourism" },
              { icon: "🏆", title: "Expert-Curated", desc: "Local insider knowledge" }
            ].map((feature, idx) => (
              <motion.div
                key={idx}
                whileHover={{ y: -5 }}
            ...
            {steps.map((step, index) => (
              <div key={step.number} className="flex items-center">
                ...
                {index < steps.length - 1 && (
                  <div className={`w-20 h-1 mx-6 transition-all duration-500 rounded-full ${
                    currentStep > step.number 
        ...
        <div className="glass-premium rounded-3xl p-10 mb-12 border border-white/20">
          ...
          {currentStep === 1 && (
            ...
            >
              <h2 className="text-3xl font-bold text-white mb-8 text-center">
                Plan Your <span className="text-emerald-400">Aaranya</span> Adventure
              </h2>
                ...
                <motion.div whileHover={{ scale: 1.02 }} className="space-y-6">
                  <div>
                    ...
                    >
                      ...
                      <option value={12}>Extended Family/Corporate (9+ people)</option>
                    </select>
                  </div>
          ...
          {currentStep === 2 && (
            ...
            >
              <h2 className="text-3xl font-bold text-white mb-8 text-center">
                Craft Your Perfect <span className="text-emerald-400">Aaranya</span> Experience
              </h2>
                    ...
                    >
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <div className="font-bold text-lg mb-2">{interest.label}</div>
                          <div className="text-sm opacity-90">{interest.description}</div>
                        </div>
                        {formData.selectedInterests.includes(interest.id) && (
                          <motion.span 
                            initial={{ scale: 0 }}
                    ...
                    >
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="text-lg font-medium mb-3">{budget.range}</div>
                          <div className="text-sm grid grid-cols-2 gap-2">
                            {budget.features.map((feature, idx) => (
                              <span key={idx} className="inline-block px-3 py-1 bg-black/20 rounded-full text-xs">
                                {feature}
                              </span>
                            ))}
                          </div>
                  ...
                  {accommodationTypes.map((acc) => (
                    ...
                    >
                      <div className="flex items-start gap-3 mb-3">
                        ...
                        <div className="flex-1">
                          <div className="font-bold text-lg mb-2">{acc.label}</div>
                          <div className="text-sm opacity-90">{acc.description}</div>
                        </div>
                        {formData.accommodation === acc.id && (
                          <motion.span 
                            initial={{ scale: 0 }}
              ...
              <div className="flex justify-between">
                ...
                <motion.button
                  ...
                  className="px-12 py-4 bg-gradient-to-r from-emerald-400 to-sky-400 text-black font-bold rounded-2xl disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-xl transition-all duration-300 text-lg"
                >
                  {isGenerating ? 'Crafting Magic...' : 'Generate My Aaranya Adventure 🚀'}
                </motion.button>
              </div>
            </motion.div>
          )}
              ...
              {isGenerating ? (
                <div className="text-center py-20">
                  ...
                  <p className="text-gray-400 mb-8 text-lg">
                    Our sophisticated algorithms are analyzing hundreds of variables to create your ultimate Aaranya experience...
                  </p>
                ...
                <>
                  <div className="text-center mb-12">
                    <h2 className="text-4xl font-bold text-white mb-4">
                      Your Personalized <span className="text-emerald-400">Aaranya</span> Adventures
                    </h2>
                  ...
                  <div className="grid lg:grid-cols-2 xl:grid-cols-3 gap-8 mb-12">
                    {generatedPlans.map((plan, index) => (
                      <motion.div
                        ...
                        whileHover={{ y: -10, boxShadow: "0 25px 50px rgba(24, 182, 104, 0.2)" }}
                      ...
                      >
                        ...
                        <div className="flex items-start justify-between mb-6">
                          <div className="flex-1">
                            <h3 className="text-white font-bold text-2xl mb-2">{plan.title}</h3>
                        ...
                        {/* Destinations */}
                        <div className="mb-6">
                          <span className="text-emerald-400 font-medium text-sm">Key Destinations:</span>
                        ...
                        {/* Highlights Preview */}
                        <div className="mb-6">
                          <span className="text-sky-400 font-medium text-sm">Experience Highlights:</span>
                          <ul className="mt-2 space-y-2">
                            {plan.detailedHighlights[0]?.experiences.slice(0, 3).map((highlight, idx) => (
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-6">
                          <div className="text-center p-3 glass-dark rounded-xl">
                            <div className="text-emerald-400 font-bold">{plan.sustainabilityScore}/10</div>
                            <div className="text-xs text-gray-400">Eco Score</div>
                          </div>
                          <div className="text-center p-3 glass-dark rounded-xl">
                            <div className="text-sky-400 font-bold">{plan.destinations.length}</div>
                        ...
                        <div className="mb-6">
                          <div className="flex flex-wrap gap-2">
                            {plan.bestFor.slice(0, 2).map((tag, idx) => (
                              <span key={idx} className="text-xs px-2 py-1 bg-gradient-to-r from-emerald-400/20 to-sky-400/20 rounded-full text-emerald-400">
                                {tag}
                              </span>
                            ))}
                          </div>
                        ...
                        >
                          {selectedPlan?.id === plan.id ? '✓ Selected - View Details' : 'Select This Adventure'}
                        </motion.button>
                      </motion.div>
                    ))}
                  </div>
                  ...
                  {selectedPlan && (
                    ...
                    >
                      ...
                      <div className="grid md:grid-cols-3 gap-6 mb-8">
                        {selectedPlan.detailedHighlights.map((category, idx) => (
                          <motion.div
                            key={idx}
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                          ...
                          >
                            ...
                            <ul className="space-y-2">
                              {category.experiences.map((exp, expIdx) => (
                                <li key={expIdx} className="text-sm text-gray-300 flex items-start gap-2">
                      ...
                      <div className="mb-8">
                        <h4 className="text-2xl font-bold text-white mb-6">Detailed Day-by-Day Journey</h4>
                          ...
                          {selectedPlan.itinerary.map((day, index) => (
                            ...
                            >
                              <div className="flex items-start gap-6">
                                ...
                                <div className="flex-1">
                                  <h5 className="text-white font-bold text-xl mb-2">{day.title}</h5>
                                  <p className="text-gray-400 mb-4">{day.location} • {day.theme}</p>
                                  
                                  <div className="grid md:grid-cols-2 gap-6 mb-6">
                                    <div>
                                      <h6 className="text-emerald-400 font-medium mb-3">🎯 Activities & Experiences</h6>
                                      <div className="space-y-3">
                                        {day.activities.map((activity, actIdx) => (
                                          <div key={actIdx} className="glass rounded-xl p-4">
                                            ...
                                            <div className="flex justify-between mt-2 text-xs">
                                              <span className="text-gray-400">Difficulty: {activity.difficulty}</span>
                                    ...
                                    <div>
                                      <h6 className="text-sky-400 font-medium mb-3">🍽️ Culinary Journey</h6>
                                      <div className="space-y-3">
                                        {day.meals.map((meal, mealIdx) => (
                                          <div key={mealIdx} className="glass rounded-xl p-4">
                                            <div className="flex items-center justify-between mb-2">
                                              <span className="text-white font-medium capitalize">{meal.type}</span>
                                              <span className="text-sky-400 text-xs">₹{meal.cost}</span>
                                            </div>
                                            <p className="text-gray-400 text-sm">{meal.venue}</p>
                                            <p className="text-white text-xs mt-1">{meal.speciality}</p>
                                          </div>
                                        ))}
                                      </div>
                                    </div>
                                  ...
                                  <div className="grid md:grid-cols-3 gap-4 text-xs">
                                    <div className="glass rounded-xl p-3">
                                      <span className="text-emerald-400 font-medium">🏨 Stay:</span>
                                      <p className="text-white mt-1">{day.accommodation.name}</p>
                                      <p className="text-gray-400">{day.accommodation.type} • ⭐ {day.accommodation.rating}</p>
                                    </div>
                                    <div className="glass rounded-xl p-3">
                                      <span className="text-sky-400 font-medium">🚗 Transport:</span>
                                      <p className="text-white mt-1">{day.transportation.mode}</p>
                                      <p className="text-gray-400">{day.transportation.distance} • {day.transportation.duration}</p>
                                    </div>
                                    <div className="glass rounded-xl p-3">
                                      <span className="text-yellow-400 font-medium">☀️ Weather:</span>
                                      <p className="text-white mt-1">{day.weather}</p>
                                      <p className="text-gray-400">🌅 {day.sunrise} | 🌅 {day.sunset}</p>
                                    </div>
                                  </div>
                                </div>
                              </div>
                      ...
                      <div className="glass-dark rounded-2xl p-6 mb-8">
                        <h4 className="text-xl font-bold text-white mb-4">💰 Investment Breakdown</h4>
                        <div className="grid md:grid-cols-3 gap-4">
                          {Object.entries(selectedPlan.priceBreakdown).map(([category, percentage]) => (
                            <div key={category} className="flex justify-between items-center p-3 glass rounded-xl">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 mb-8">
                        <div className="glass-dark rounded-2xl p-6">
                          <h4 className="text-xl font-bold text-emerald-400 mb-4">💡 Expert Insider Tips</h4>
                          <ul className="space-y-2">
                        ...
                        <div className="glass-dark rounded-2xl p-6">
                          <h4 className="text-xl font-bold text-sky-400 mb-4">🤫 Local Secrets</h4>
                          <ul className="space-y-2">
                      ...
                      {/* Testimonials */}
                      <div className="mb-8">
                        <h4 className="text-2xl font-bold text-white mb-6">🌟 Traveler Experiences</h4>
                        <div className="grid md:grid-cols-2 gap-6">
                          {selectedPlan.testimonials.map((testimonial, idx) => (
                            ...
                            >
                              ...
                              <p className="text-gray-300 text-sm mb-4">"{testimonial.review}"</p>
                              <div className="text-emerald-400 text-xs font-medium mb-1">{testimonial.highlight}</div>
                              <div className="text-gray-400 text-xs">— {testimonial.name}, {testimonial.location}</div>
                            </motion.div>
                          ))}
                        </div>
                      </div>
                      ...
                      <div className="flex gap-4">
                        <motion.button
                          whileHover={{ scale: 1.02, boxShadow: "0 20px 40px rgba(24, 182, 104, 0.3)" }}
                          whileTap={{ scale: 0.98 }}
        ...
        >
          <h3 className="text-2xl font-bold text-white mb-6">
            Powered by Advanced <span className="text-emerald-400">Aaranya AI</span>
          </h3>
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { icon: "🧠", title: "Smart Learning", desc: "AI learns from every interaction" },
              { icon: "🔄", title: "Real-time Updates", desc: "Weather, events, and conditions" },
              { icon: "🎯", title: "Precision Matching", desc: "99.2% satisfaction rate" },
              { icon: "🌱", title: "Sustainable Focus", desc: "Eco-conscious recommendations" }
            ].map((feature, idx) => (
              <motion.div
                key={idx}
