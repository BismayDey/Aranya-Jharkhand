...
import { Eye, EyeOff, Mail, Lock, User, Phone, UserPlus, Users, Building, Compass, Mountain, TreePine, Waves, ArrowLeft } from 'lucide-react';
        ...
        <div className="absolute inset-0">
          ...
          >
            <svg viewBox="0 0 100 100" className="w-full h-full text-[#18B668]">
              <path fill="currentColor" d="M50 5 L95 50 L50 95 L5 50 Z M50 15 L85 50 L50 85 L15 50 Z M50 25 L75 50 L50 75 L25 50 Z"/>
            </svg>
          </motion.div>
          ...
          >
            <svg viewBox="0 0 100 100" className="w-full h-full text-[#F59E0B]">
              <polygon points="50,5 90,35 75,85 25,85 10,35" fill="none" stroke="currentColor" strokeWidth="3"/>
              <polygon points="50,20 75,40 65,70 35,70 25,40" fill="none" stroke="currentColor" strokeWidth="2"/>
          ...
          >
            ...
            <div className="glass-premium rounded-3xl p-8 relative overflow-hidden backdrop-blur-xl">
              ...
              <div className="mb-8 relative z-10">
                <Label className="text-white/90 text-sm mb-4 block">Join as:</Label>
              ...
              <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
                ...
                <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                  ...
                  >
                    {isLoading ? (
                      ...
                      `Create ${selectedUserType === 'guest' ? 'Guest' : 'Host'} Account`
                    )}
                  </Button>
                </motion.div>
                ...
                <div className="relative my-6">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-4 glass-dark text-white/70 rounded-full">Or sign up with</span>
                  </div>
                </div>
