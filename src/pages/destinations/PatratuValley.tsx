...
const destination = {
  ...
  description:
    "Patratu Valley is a scenic destination known for its beautiful dam, serene lake, and picturesque landscapes. It's perfect for nature lovers seeking tranquility and natural beauty.",
  heroImage:
    "https://images.unsplash.com/photo-1710349603727-57855d011a01?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx2YWxsZXklMjBsYWtlJTIwc2NlbmljJTIwbmF0dXJlfGVufDF8fHx8MTc1NjU0Mjc5NXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  gallery: [
    "https://images.unsplash.com/photo-1710349603727-57855d011a01?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx2YWxsZXklMjBsYWtlJTIwc2NlbmljJTIwbmF0dXJlfGVufDF8fHx8MTc1NjU0Mjc5NXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  ...
  highlights: [
    {
      icon: Waves,
      title: "Patratu Dam",
      description: "Beautiful dam with scenic lake views",
    },
    {
      icon: Mountain,
      title: "Valley Views",
      description: "Stunning panoramic valley landscapes",
    },
    {
      icon: Camera,
      title: "Photography",
  ...
  nearbyAttractions: [
    { name: "Ramgarh Cantonment", distance: "15km", type: "Historical" },
    { name: "Chinnamasta Temple", distance: "25km", type: "Religious" },
    { name: "Rajrappa Falls", distance: "30km", type: "Waterfall" },
  ],
  tips: [
    "Best visited during clear weather for valley views",
    "Carry snacks as limited food options available",
    "Early morning visits offer best photography light",
    "Respect the dam area restrictions",
    "Ideal for peaceful getaways",
  ],
};

export function PatratuValley() {
