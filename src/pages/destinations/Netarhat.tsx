...
const destination = {
  ...
  description:
    "Netarhat, situated at an elevation of 1,128 meters, is a picturesque hill station known for its breathtaking sunrise and sunset views, dense forests, and pleasant climate throughout the year.",
  heroImage:
    "https://images.unsplash.com/photo-1629977681408-e6e6876645c0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb3VudGFpbiUyMHN1bnJpc2UlMjBsYW5kc2NhcGV8ZW58MXx8fHwxNzU2NTA1MzQ5fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  gallery: [
    "https://images.unsplash.com/photo-1629977681408-e6e6876645c0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb3VudGFpbiUyMHN1bnJpc2UlMjBsYW5kc2NhcGV8ZW58MXx8fHwxNzU2NTA1MzQ5fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  ...
  highlights: [
    {
      icon: Mountain,
      title: "Sunrise Point",
      description: "Spectacular sunrise views from the hilltop",
    },
    {
      icon: TreePine,
      title: "Dense Forests",
      description: "Rich biodiversity and peaceful nature walks",
    },
    {
      icon: Camera,
      title: "Photography",
      description: "Perfect for landscape and nature photography",
    },
    {
      icon: Thermometer,
      title: "Pleasant Climate",
      description: "Cool weather throughout the year",
    },
  ],
  activities: [
  ...
  nearbyAttractions: [
    { name: "Betla National Park", distance: "25km", type: "Wildlife" },
    { name: "Koel View Point", distance: "8km", type: "Scenic" },
    { name: "Palamau Tiger Reserve", distance: "30km", type: "Wildlife" },
  ],
  accommodation: [
    {
      type: "Government Rest House",
      price: "₹800-1200/night",
      amenities: ["Basic rooms", "Canteen"],
    },
    {
      type: "Private Hotels",
      price: "₹1500-3000/night",
      amenities: ["AC rooms", "Restaurant", "Room service"],
    },
    {
      type: "Camping",
      price: "₹500-800/night",
      amenities: ["Tents", "Bonfire", "Meals"],
    },
  ],
  howToReach: {
    air: "Ranchi Airport (154km) - Drive via NH99",
    rail: "Daltonganj Railway Station (65km) - Taxi/Bus available",
    road: "Well connected by road from Ranchi, Daltonganj, and major cities",
  },
  tips: [
    "Carry warm clothes as it gets cold in the evenings",
    "Book accommodation in advance, especially during peak season",
    "Start early for sunrise point (around 5:30 AM)",
    "Carry camera with extra batteries for photography",
    "Respect local forest rules and don't litter",
  ],
};

export function Netarhat() {
