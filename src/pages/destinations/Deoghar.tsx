...
const destination = {
  id: "deoghar",
  name: "Deoghar",
  tagline: "Sacred Temple Town",
  description:
    'Deoghar, meaning "abode of gods," is one of the most sacred pilgrimage sites in India, famous for the Baidyanath Temple, one of the twelve Jyotirlingas. The town combines spiritual significance with natural beauty.',
  heroImage:
    "https://images.unsplash.com/photo-1656947165986-9f0696776dd4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0ZW1wbGUlMjBhcmNoaXRlY3R1cmUlMjBpbmRpYXxlbnwxfHx8fDE3NTY0OTEyMzV8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  gallery: [
    "https://images.unsplash.com/photo-1656947165986-9f0696776dd4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0ZW1wbGUlMjBhcmNoaXRlY3R1cmUlMjBpbmRpYXxlbnwxfHx8fDE3NTY0OTEyMzV8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    "https://images.unsplash.com/photo-1585563741139-4d488b8291c4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0cmliYWwlMjBjdWx0dXJlJTIwZGFuY2UlMjBpbmRpYXxlbnwxfHx8fDE3NTY1NDIwNTh8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
  ],
  rating: 4.6,
  reviews: 334,
  ...
  highlights: [
    ...
    },
    {
      ...
      description: "Deep cultural and religious experiences",
    },
    {
      icon: TreePine,
      title: "Trikuta Hills",
      description: "Sacred hills with multiple temples",
    },
    {
      icon: Camera,
      title: "Cultural Heritage",
      description: "Rich traditions and festivals",
    },
  ],
  activities: [
    "Temple Visits",
    ...
    "Ropeway Ride (Trikuta Hills)",
    "Local Markets",
    "Photography",
  ],
  nearbyAttractions: [
    { name: "Trikuta Hills", distance: "10km", type: "Religious" },
    { name: "Nandan Pahar", distance: "12km", type: "Hill Station" },
    { name: "Mayurbhanj Palace", distance: "5km", type: "Historical" },
  ],
  tips: [
    ...
    "Try local prasadam and traditional food",
  ],
};

export function Deoghar() {
